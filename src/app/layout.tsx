...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "lifted truck insurance",
    "agreed value mortality insurance",
    "modified vehicle mortality insurance",
    "lifted truck property insurance",
    "modified trucking parlor insurance",
    "modified truck spoilage insurance",
    "equipment breakdown dairy",
    "dairy product liability",
    "manure runoff pollution insurance",
    "dairy workers compensation",
    "modified truck tanker commercial auto",
  ],
  ...
  twitter: {
    ...
    title: `${SITE.name} | Contractors Choice Agency`,
    description:
      "Specialized insurance for lifted trucks. Livestock mortality, parlor & barn property, equipment breakdown & modified truck spoilage, product liability, pollution, workers' comp, and auto. 15-minute quotes.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const orgSchema = {
    ...
    serviceType: [
      ...
      "Equipment Breakdown & Modified Truck Spoilage Insurance",
      "Dairy Product Liability Insurance",
      "General Liability Insurance for Lifted Trucks",
      "Workers' Compensation for Dairy Crews",
      "Commercial Auto & Trucking for Modified Truck Tankers",
